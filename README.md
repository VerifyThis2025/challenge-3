# VerifyThis 2025 - Challenge 3

This is the first challenge for the VerifyThis 2025 competition. Please see the file [challenge-3.pdf](challenge-3.pdf) for the problem description and list of tasks.
...
* Then execute the following git command: <br/>
  ```bash
  git clone https://github.com/VerifyThis2025/challenge-3-<YOUR-TEAM-NAME>.git challenge-3
  cd challenge-3
  ```
